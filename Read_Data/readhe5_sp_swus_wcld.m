%%readhe5_sp_swus_wcld
%%arr 05/05/2011

%run in command prompt using batch file read_swus.bat 
...
last_file=dir(fullfile('J:','New_Retrieval_sp_mats','SWUS_wcld'));
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%                                                    
        ...
        cd J:\New_Retrieval_sp_mats\SWUS_wCld
