%%readhe5_sp_seus_wcld
%%arr 04/28/2011

%run in command prompt using batch file read_seus.bat 
...
last_file=dir(fullfile('J:','New_Retrieval_sp_mats','SEUS_wcld'));
...
for j=1:total_days;
    ...
    if isempty(a);
        ...
        for e=1:n    %for loop over all swaths from a day 
            ...
            if str2double(filename(29:30))<15||str2double(filename(29:30))>22%||exist(filename2,'file')==0;
                continue
            else      
            cd(directory)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%                                                    
        ...
        cd J:\New_Retrieval_sp_mats\SEUS_wCld
